...
import PickleLogo from "../assets/thop_logo2.png";
...
export const Navbar = () => {
  ...
  // Track navbar height for proper mobile menu positioning
  useEffect(() => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`absolute inset-0 backdrop-blur-md bg-background/10 transition-all duration-300 ease-in-out ${
